    ...
    <div className="flex flex-grow flex-col items-center px-8 py-3 sm:px-5 overflow-hidden">
      ...
      <div className="my-3 mt-6 flex w-full max-w-[600px] flex-col items-center gap-3 sm:my-5">
        <div className="flex flex-row gap-x-2">
          {/* Auth gate (restore when done testing roadmap page):
          {user ? (
            <LinkWithViewTransitions href="/roadmap">...</LinkWithViewTransitions>
          ) : (
            <SignInButton mode="modal" fallbackRedirectUrl="/roadmap">...</SignInButton>
          )}
          */}
